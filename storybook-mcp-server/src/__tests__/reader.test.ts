...
describe('ReaderSimulator', () => {
  ...
  describe('adult reader simulation', () => {
    ...
    test('exhibits less skimming behavior', () => {
      ...
      expect(skimmingBehaviors.length).toBeLessThanOrEqual(
        result.reading_timeline.length * 0.2
      );
    });
