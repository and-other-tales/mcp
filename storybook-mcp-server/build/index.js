...
server.tool("analyze-dialogue", "Analyze dialogue flow and provide suggestions for improvement", {
...
server.tool("analyze-emotions", "Analyze emotional content and pacing", {
    text: z.string().describe("The manuscript text to analyze"),
    sceneDelimiter: z.string().optional().default("***").describe("Scene delimiter")
}, async ({ text, sceneDelimiter }) => {
    try {
...
server.tool("analyze-characters", "Analyze character continuity and interactions", {
    text: z.string().describe("The manuscript text to analyze"),
    mainCharacters: z.array(z.string()).optional().describe("List of main characters to track")
}, async ({ text, mainCharacters }) => {
    try {
...
server.tool("analyze-events", "Analyze event continuity and timeline consistency", {
    text: z.string().describe("The manuscript text to analyze")
}, async ({ text }) => {
    try {
...
server.tool("analyze-manuscript", "Perform comprehensive analysis of the manuscript", {
    text: z.string().describe("The manuscript text to analyze"),
    sceneDelimiter: z.string().optional().default("***").describe("Scene delimiter"),
    mainCharacters: z.array(z.string()).optional().describe("List of main characters to track")
}, async ({ text, sceneDelimiter, mainCharacters }) => {
    try {
        const [dialogueResult, emotionalResult, characterResult, eventResult] = await Promise.all([
...
server.tool("simulate-reader", "Simulate how different types of readers would experience the manuscript", {
    text: z.string().describe("The manuscript text to analyze"),
...
server.tool("analyze-repetitions", "Analyze word and phrase repetitions in the manuscript", {
    text: z.string().describe("The manuscript text to analyze")
}, async ({ text }) => {
    try {
...
server.tool("suggest-alternatives", "Find contextually appropriate alternatives for repeated words or phrases", {
